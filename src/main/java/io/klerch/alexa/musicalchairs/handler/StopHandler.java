...
@AlexaIntentListener(builtInIntents = {AlexaIntentType.INTENT_STOP, AlexaIntentType.INTENT_CANCEL, AlexaIntentType.INTENT_NO})
public class StopHandler implements AlexaIntentHandler {
    @Override
